...
# @faustbrian/node-delegated-proof-of-work

[![npm version](https://badgen.net/npm/v/@faustbrian/node-delegated-proof-of-work)](https://npm.im/@faustbrian/node-delegated-proof-of-work)

## Installation

```
pnpm install @faustbrian/node-delegated-proof-of-work
```

## Usage

```ts
import { IValidator, mine, round, validator } from "@faustbrian/node-delegated-proof-of-work";
